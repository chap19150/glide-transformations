 ...
 */
public class ToasterFilterTransformation implements Transformation<Bitmap> {

    private Context mContext;
    private BitmapPool mBitmapPool;

    private ToasterFilter mFilter;

    public ToasterFilterTransformation(Context context, BitmapPool pool) {
        mContext = context;
        mBitmapPool = pool;
        mFilter = new ToasterFilter(context);
    }
    ...
    @Override
    public String getId() {
        return "ToasterFilterTransformation";
    }

    public static class ToasterFilter extends BaseImageFilter {
