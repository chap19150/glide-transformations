...
public class HudsonFilterTransformation implements Transformation<Bitmap> {

    private Context mContext;
    private BitmapPool mBitmapPool;

    private HudsonFilter mFilter;

    public HudsonFilterTransformation(Context context, BitmapPool pool) {
        mContext = context;
        mBitmapPool = pool;
        mFilter = new HudsonFilter(context);
    }
    ...
    @Override
    public String getId() {
        return "HudsonFilterTransformation";
    }

    public static class HudsonFilter extends BaseImageFilter {
