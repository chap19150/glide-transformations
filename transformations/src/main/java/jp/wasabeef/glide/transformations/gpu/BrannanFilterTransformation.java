 ...
 */
public class BrannanFilterTransformation implements Transformation<Bitmap> {

    private Context mContext;
    private BitmapPool mBitmapPool;

    private BrannanFilter mFilter;

    public BrannanFilterTransformation(Context context, BitmapPool pool) {
        mContext = context;
        mBitmapPool = pool;
        mFilter = new BrannanFilter(context);
    }
    ...
    @Override
    public String getId() {
        return "BrannanFilterTransformation";
    }

    public static class BrannanFilter extends BaseImageFilter {
