 ...
 */
public class AmaroFilterTransformation implements Transformation<Bitmap>{

        private Context mContext;
        private BitmapPool mBitmapPool;

        private AmaroFilter mFilter;

        public AmaroFilterTransformation(Context context, BitmapPool pool) {
        mContext = context;
        mBitmapPool = pool;
        mFilter = new AmaroFilter(context);
    }
        ...
        @Override
        public String getId() {
        return "AmaroTransformation";
    }

    public static class AmaroFilter extends BaseImageFilter {
