 ...
 */
public class LomoFiFilterTransformation implements Transformation<Bitmap> {

    private Context mContext;
    private BitmapPool mBitmapPool;

    private LomoFiFilter mFilter;

    public LomoFiFilterTransformation(Context context, BitmapPool pool) {
        mContext = context;
        mBitmapPool = pool;
        mFilter = new LomoFiFilter(context);
    }
    ...
    @Override
    public String getId() {
        return "LomoFiFilterTransformation";
    }

    public static class LomoFiFilter extends BaseImageFilter {
