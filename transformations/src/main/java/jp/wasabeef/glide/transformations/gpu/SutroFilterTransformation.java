 ...
 */
public class SutroFilterTransformation implements Transformation<Bitmap> {

    private Context mContext;
    private BitmapPool mBitmapPool;

    private SutroFilter mFilter;

    public SutroFilterTransformation(Context context, BitmapPool pool) {
        mContext = context;
        mBitmapPool = pool;
        mFilter = new SutroFilter(context);
    }
    ...
    @Override
    public String getId() {
        return "SutroFilterTransformation";
    }

    public static class SutroFilter extends BaseImageFilter {
