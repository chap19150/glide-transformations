 ...
 */
public class EarlybirdFilterTransformation implements Transformation<Bitmap> {

    private Context mContext;
    private BitmapPool mBitmapPool;

    private EarlybirdFilter mFilter;

    public EarlybirdFilterTransformation(Context context, BitmapPool pool) {
        mContext = context;
        mBitmapPool = pool;
        mFilter = new EarlybirdFilter(context);
    }
    ...
    @Override
    public String getId() {
        return "EarlybirdFilterTransformation";
    }

    public static class EarlybirdFilter extends BaseImageFilter {
