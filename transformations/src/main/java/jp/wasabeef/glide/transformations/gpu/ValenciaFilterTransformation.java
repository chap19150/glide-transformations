 ...
 */
public class ValenciaFilterTransformation implements Transformation<Bitmap> {

    private Context mContext;
    private BitmapPool mBitmapPool;

    private ValenciaFilter mFilter;

    public ValenciaFilterTransformation(Context context, BitmapPool pool) {
        mContext = context;
        mBitmapPool = pool;
        mFilter = new ValenciaFilter(context);
    }
    ...
    @Override
    public String getId() {
        return "ValenciaFilterTransformation";
    }

    public static class ValenciaFilter extends BaseImageFilter {
