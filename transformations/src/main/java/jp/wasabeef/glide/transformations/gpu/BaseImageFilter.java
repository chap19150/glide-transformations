...
public class BaseImageFilter extends GPUImageFilter {
    ...
    public BaseImageFilter(String fragmentShader, int textures) {
        this(VERTEX_SHADER, fragmentShader, textures);
    }

    public BaseImageFilter(String vertexShader, String fragmentShader, int textures) {
